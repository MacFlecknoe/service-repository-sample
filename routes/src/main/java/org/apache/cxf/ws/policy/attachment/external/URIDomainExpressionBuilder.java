...
public class URIDomainExpressionBuilder implements DomainExpressionBuilder {
	private static final Collection<QName> SUPPORTED_TYPES = Collections
			.unmodifiableList(Arrays.asList(new QName[] {
					new QName("http://www.w3.org/ns/ws-policy", "URI"),
					new QName("http://schemas.xmlsoap.org/ws/2004/09/policy",
							"URI") }));
